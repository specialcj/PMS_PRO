...
{
    public partial class FrmConvertToICO : Form
    {
        public FrmConvertToICO()
        {
            InitializeComponent();
        }
        ...
        {
            string fileClass = "";
            //string filePath = @"D:\_VNE_Work\_SendAnywhere\IMG_7760.jpg";
            string filePath = @"D:\_VNE_Work\CSharp\PMS\WinPMS\Ico\P.ico";
            
            IsPicture(out fileClass, filePath);
        }
        ...
        private bool IsPicture(out string typeName, string filePath)
        {
            try
            {
                ...
                fileExtension = (FileExtension)Enum.Parse(typeof(FileExtension), sFileType);

                if (
                    fileExtension == FileExtension.FILE_HEAD_BMP ||
                    fileExtension == FileExtension.FILE_HEAD_JPG ||
                    fileExtension == FileExtension.FILE_HEAD_PNG ||
                    fileExtension == FileExtension.FILE_HEAD_GIF ||
                    fileExtension == FileExtension.FILE_HEAD_GIF
                    )
                {
                    typeName = sFileType;
        ...
        public enum FileExtension
        {
            ...
            FILE_HEAD_ZIP = 8075,
            FILE_HEAD_7Z = 55122,
            FILE_HEAD_EXE_DLL = 7790,
            FILE_HEAD_XML = 6063,
            FILE_HEAD_HTML = 6033,
            FILE_HEAD_ASPX = 239187,
            FILE_HEAD_CS = 117115,
            FILE_HEAD_JS = 119105,
            FILE_HEAD_TXT = 102100,
            FILE_HEAD_SQL = 255254,
        }
    }
}
